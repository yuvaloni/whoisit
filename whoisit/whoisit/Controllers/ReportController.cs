...
namespace whoisit.Controllers
{
    ...
    {
        public HttpResponseMessage PutReport(string reporter, string character, string post)
        {
            ...
            r2.Close();
            SqlCommand com4 = new SqlCommand("UPDATE "+character+"_CHARACTER SET reports=@t WHERE id=@i", con);
